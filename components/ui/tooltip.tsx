...
/* oxlint-disable react/react-compiler, jsx-a11y/no-static-element-interactions -- Positioning intentionally reads live element geometry; the wrapper observes events bubbling from the interactive child without replacing its semantics. */
...
function getGap() {
  ...
  return Number.parseFloat(value) || FALLBACK_GAP;
}
                ...
                >
                  <TooltipSurface
                    ...
                    style={{
                      ...
                      maxWidth: 'calc(100vw - var(--space-sm))',
                      whiteSpace: 'normal',
                    }}
                    className={className}
                  >
