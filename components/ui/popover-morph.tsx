...
import { usePopoverPortalPosition } from "@/lib/hooks/use-popover-portal-position";
    ...
    <AnimatePresence>
      {ctx.open ? (
        <motion.div
          ...
          className="ui-scope fixed z-[9999] [filter:drop-shadow(0_10px_18px_rgba(0,0,0,0.14))]"
        >
          <motion.div
            ref={ctx.contentRef}
            id={ctx.contentId}
