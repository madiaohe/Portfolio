/**
 * HookSidebar — from Rare UI (swamimalode07/rare-ui), MIT.
 * https://github.com/swamimalode07/rare-ui
 * Installed for review on the /components gallery; token classes resolve
 * through app/components.css (--foreground → --minimal-text, etc.).
 */
"use client";
    ...
    >
      {label && (
        <span
          ...
          className="pb-3 pl-0.5 pr-2 text-sm text-muted-foreground"
        >
          {label}
        </span>
      )}
